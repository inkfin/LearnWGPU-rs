...
export function wasm_bindgen__convert__closures__invoke1_mut__h2c87d5bf8ba070fc(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hd18c81d24f0150f7(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h8742fd95bdac56a7(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h7387c2c99a94ffab(a: number, b: number, c: number): void;
